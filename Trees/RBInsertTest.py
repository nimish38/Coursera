import random
from Trees import RBInsert as RBI
...
setattr(RBI.RBTree, "ref_implementation", ref_implementation)
setattr(RBI.RBNode, "inorder", inorder)
setattr(RBI.RBTree, "__repr__", print_tree)
