import random
from Trees import BSTDeletion as BTSD
...
setattr(BTSD.BSTNode, "inorder_char_names", inorder_char_names)
setattr(BTSD.BSTNode, "__repr__", print_tree)
